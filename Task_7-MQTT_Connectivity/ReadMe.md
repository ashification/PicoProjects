...
If you do not have access to one you can utilise the HiveMQ Free Broker by going to their [dashboard](https://www.mqtt-dashboard.com/) as sn below:
<br/>
![Screenshot for hiveMq Dashboard](https://github.com/ashification/PicoProjects/tree/main/Task_7-MQTT_Connectivity/hivemq-dashboard.png)
<br/><br/> 

when you click on connect the details shown are what you will use in your config file
![Screenshot for hiveMQ Broker Details](https://github.com/ashification/PicoProjects/tree/main/Task_7-MQTT_Connectivity/hivemq-brokerdetails.png)
<br/><br/> 


[HiveMQ Websocket Client](https://www.hivemq.com/demos/websocket-client/)
![Screenshot for Websocket Client](https://github.com/ashification/PicoProjects/tree/main/Task_7-MQTT_Connectivity/hiveMQ-websocketclient.png)
